    ...
    case ESP_GAP_BLE_SCAN_RESULT_EVT: 
    {
        ...
        case ESP_GAP_SEARCH_INQ_RES_EVT:
            ...
            if (esp_ble_is_ibeacon_packet(scan_result->scan_rst.ble_adv, scan_result->scan_rst.adv_data_len))
            {
                ...
                double mp = ibeacon_data->ibeacon_vendor.measured_power, rssi = scan_result->scan_rst.rssi, resultado, distancia;

                distancia = (mp - rssi) / 20;
                resultado = pow(10, distancia);

                if(major == 44024 && minor == 62802){
                    ...
                    ESP_LOGI(DEMO_TAG, "Dist̢ncia: %.2lf m", resultado);
                    ...
                    } else if(resultado > 1.0 && resultado < 3.0) {
...
void app_main(void)
{
    ...
    gpio_pad_select_gpio(PIN_LED_GREEN);
